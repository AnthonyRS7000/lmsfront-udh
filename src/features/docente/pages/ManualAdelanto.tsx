...
const ManualAdelanto: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setPdfUrl('http://www.udh.edu.pe/websauh/manualdeadelantos.pdf');
      } catch (error) {
        setError(true);
      }finally {
        setLoading(false);
  ...
  return (
    <div className="reglamento-container">
      <TituloPage titulo="Manual del Adelanto" />
      <Card>
