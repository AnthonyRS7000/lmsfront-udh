...
export const cursos = [
    ...
    { id: 6, nombre: "Farmacología", grupo: "B", destacado: false },
    { id: 7, nombre: "Farmacología", grupo: "B", destacado: false },
...
function Cursos() {
    ...
    const grupos = ["Todos", ...Array.from(new Set(cursos.map(c => c.grupo)))];
  return (
