...
export { default as PlanDeEstudios } from './pages/PlanDeEstudios';
export { default as MallaCurricular } from './pages/MallaCurricular';
export { default as RendimientoAcademico } from './pages/RendimientoAcademico';
